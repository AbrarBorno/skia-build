...
def main():
  ...
  try:
    ...
    resp = urllib.request.urlopen(urllib.request.Request('https://api.github.com/repos/AbrarBorno/skia-build/releases', data=data.encode('utf-8'), headers=headers)).read()
